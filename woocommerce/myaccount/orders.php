...
<?php else : ?>
	<div class="form-group">
        ...
        <a class="woocommerce-Button button" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
            <?php _e( 'Make an order.', 'woocommerce' ) ?>
        </a>
	</div>
<?php endif; ?>

<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="btn btn-danger">
    Back to my account
</a>
